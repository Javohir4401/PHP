...
<?php
    $xabar = "Salom, Ro'yxatdan o'tish sahifasiga xush kelibsiz!";
    echo "<h2>$xabar</h2>";
?>
...
<form action="2.php" method="POST">
    ...
    <input type="tel" id="telefon" name="telefon" pattern="\+998[0-9]{9}" 
           placeholder="+998901234567" value="+998" required><br><br>
